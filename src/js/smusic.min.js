...
function d(a,b){
	var d=a.className;
	c(a,b)&&(d=d.replace(new RegExp("(\\s|^)"+b+"(\\s|$)")," "),
	d=d.replace(/(^\s*)|(\s*$)/g,""),
	a.className=d)
	}
function e(a,e){
...
function h(a){
	...
	"0"!=b&&(1==b.length&&(b="0"+b),
	e+=b+":"),1==c.length&&(c="0"+c),
	e+=c+":",1==d.length&&(d="0"+d),
	e+=d}
function j(a){
	var b=this.config;
	this.config=g(b,a),
			...
			setBuffer:function(a,b){
				...
				i=setInterval(function(){
					...
					if(d>0&&void 0!=a.buffered){
						...
						b.style.width=e+"px",
						Math.abs(a.duration-a.buffered.end(d-1))<1&&(b.style.width=c+"px",
						clearInterval(i)
						)}},1e3)},
						resetPlayer:function(a){
							...
							e=this,
							f=function(){
								return e.setBuffer(this,
									e.musicDom.bufferProcess)};
